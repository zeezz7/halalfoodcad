      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between items-start mb-16">
          ...
          <div className="w-full md:w-auto mb-6 md:mb-0">
            <Link
              href="/"
              className="text-2xl font-semibold hover:text-[#FFEA00] transition-colors cursor-pointer"
            >
              HALAL GOES
            </Link>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 text-[#ffffff]">
                <a
                  href="#"
                  className="flex items-center bg-black rounded-lg px-4 py-2 w-48 hover:bg-gray-900 transition border border-[#FFEA00]"
          ...
          <div className="w-full md:w-auto mb-6 md:mb-0">
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="hover:text-[#FFEA00] transition-colors cursor-pointer"
                >
                  Home
                </Link>
              </li>
          ...
          <div className="w-full md:w-auto flex justify-center md:justify-end">
            <button
              onClick={scrollToTop}
              className="bg-[#FFEA00] rounded-full w-10 h-10 flex items-center justify-center"
